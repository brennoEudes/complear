...
## Activities
My responsibilities were to updated and to develop new front-end features in the Complear platform, building and stylizing new components, such as login and profile pages, buttons, card's information, menu icons, and product forms.

Moreover, I created new product pages, with an authentication system, to verify and display the product information according to the user type. In this context, it was required to create relations between the front-end product pages components, the back-end (installing NodeJS), and the Database (installing Mongo DB).

See the details in the 2 min video attached.
